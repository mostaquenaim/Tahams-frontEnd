...
const CentralPanelPreviewDraft = ({
  panelStyle,
  headingTitle,
  canvasRef,
  selectedColor,
  ...
  return (
    <div className="lg:col-span-6">
      <div className={panelStyle}>
        ...
        {/* front print size toggle */}
        {viewSide === 'front' && (
          <div className="flex flex-wrap items-center gap-2 mb-4">
            <button
              onClick={() => setPrintSizeOption('normal')}
              className={`px-3 py-2.5 rounded-lg text-sm font-medium transition-colors ${
                printSizeOption === 'normal'
                  ? 'bg-black text-white'
            ...
            <button
              onClick={() => setPrintSizeOption('large')}
              className={`px-3 py-2.5 rounded-lg text-sm font-medium transition-colors ${
                printSizeOption === 'large'
                  ? 'bg-black text-white'
                  : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
            >
        ...
        {/* elements */}
<div className="flex flex-wrap gap-5 my-3 justify-start">
  {/* select color */}
  <div className="relative">
    ...
    {expanded && (
      <div className="absolute mt-2 flex flex-col gap-2 bg-white rounded-lg shadow-lg border">
        ...
        <div className="w-full flex justify-center">
          <div
            ...
            style={{
              ...
              aspectRatio: '4 / 5', // 5:4 aspect ratio
          ...
          >
            ...
            <div
              ...
              style={{
                left:
                  viewSide === 'front' && printSizeOption === 'large'
                    ? device === 'mobile'
                      ? '24%'
                      : '23%'
                    : '26.5%',
...
export default CentralPanelPreviewDraft;
