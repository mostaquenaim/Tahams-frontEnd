...
export default function AddTest() {
    ...
    const loadSubSubCategories = async () => {
        try {
            const result = await axios.get('http://tahamsbd.com/api/admin/view-product-sub-sub-categories');
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await axios.post("http://tahamsbd.com/api/admin/add-product",
                formData, {
                headers: {
    ...
    const onSubmitPictures = async (data) => {
        ...
        try {
            const response = await axios.post("http://tahamsbd.com/api/admin/add-product-pictures",
                formData, {
                headers: {
                    "Content-Type": "multipart/form-data"
                }
