...
const UpdateCategory = ({ item }) => {
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            if (checkAvailability) 
            {
                ...
                await axios.put(`https://tahams-test-production.up.railway.app/admin/updateCategory/${item.id}`, updatedData);
    ...
    const handleDelete = async () => {
        try {
            ...
            const response = await axios.delete(`https://tahams-test-production.up.railway.app/admin/deleteCategory/${item.id}`);
            ...
            <div className="flex flex-col justify-center items-center text-center bg-gradient-to-b from-zinc-50 to-blue-100 h-screen">
                <div className="p-5 bg-white shadow-md w-96 flex flex-col gap-3 rounded-lg">
                    ...
                    <div className="my-2">
                        {item.filename && (
                            <img
                                src={`https://tahams-test-production.up.railway.app/admin/getImage/${item.filename}`}
                                alt="User Image"
                                onError={(e) => {
...
export async function getServerSideProps(context) {
    ...
    const response = await axios.get(`https://tahams-test-production.up.railway.app/admin/getCategoryById/${id}`);
