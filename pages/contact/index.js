...
const Contact = () => {
  return (
    <>
      ...
      <div className="bg-gray-100 py-20 pt-52 lg:pt-60 px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white p-8 shadow-lg rounded-lg space-y-8">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    2nd Floor, 2-G/8, Maa House, Golden Street, Ring Rd, Dhaka
                    1207
                  </p>

                  <p className="text-gray-600">
                    <span className="font-semibold">Display Center 1:</span>{' '}
                    35-36, 2nd Floor, Shahabuddin Plaza, Ring Road, Dhaka 1207
                  </p>
                  <p className="text-gray-600">
                    <span className="font-semibold">Display Center 2:</span>{' '}
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+88 016020-54102</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
