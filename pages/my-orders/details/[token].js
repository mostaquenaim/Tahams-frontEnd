                        ...
                        {orderDetails.length > 0 && (
                            <div className="flex items-center text-blue-100">
                                ...
                                <p className="text-sm md:text-base">
                                    Ordered on {new Date(orderDetails[0].history.BuyingDate).toLocaleDateString('en-US', { 
                                        year: 'numeric', 
                                        month: 'long', 
                                        day: 'numeric' 
                                    })}
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 text-sm">
                                            <p className="text-gray-600">
                                                <span className="font-medium">Category:</span> {order.category.category.category.name}
                                            </p>
                                            <p className="text-gray-600">
                                                <span className="font-medium">Size:</span> {order.size || "N/A"}
                                            </p>
                                            <p className="text-gray-600">
                                                <span className="font-medium">Quantity:</span> {order.Quantity}
                                            </p>
                                            <p className="text-gray-600">
                                                <span className="font-medium">Price:</span> {order.totalPrice} BDT
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden sticky top-6">
                            ...
                            <div className="p-6 space-y-4">
                                ...
                                <div className="flex items-center justify-between pb-4 border-b border-gray-200">
                                    ...
                                    <span className={`px-4 py-2 rounded-full text-sm font-semibold border ${getStatusColor(orderDetails[0].history.deliveryStatus.name)}`}>
                                ...
                                <div className="space-y-3 pb-4 border-b border-gray-200">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className={`font-medium ${orderDetails[0].history.PaymentDone ? 'text-green-600' : 'text-orange-600'}`}>
                                ...
                                <div className="space-y-2 pb-4 border-b border-gray-200">
                                    <div className="flex justify-between text-gray-600">
                                        <span>Subtotal:</span>
                                        <span>{orderDetails.reduce((acc, current) => acc + current.totalPrice, 0)} BDT</span>
                                    </div>
                                    <div className="flex justify-between text-gray-600">
                                ...
                                <div className="flex justify-between text-lg font-bold text-gray-800 pt-2">
                                    ...
                                    <span className="text-blue-600">
                                        {orderDetails.reduce((acc, current) => acc + current.totalPrice, 0) + orderDetails[0].history.deliveryFee} BDT
                                    </span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="p-6 space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-800 font-medium">{orderDetails[0].customer.name}</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-800 font-medium break-all">{orderDetails[0].customer.email}</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-800 font-medium">{orderDetails[0].history.phone_no}</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-800 font-medium">
                                            {orderDetails[0].history.address}, {orderDetails[0].history.region}
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                {loading ? (
                    ...
                    <div className="flex justify-center items-center h-96">
                        <div className="text-center">
                            ...
                            <p className="text-xl text-gray-600">Order details not available.</p>
                        </div>
                    </div>
                )}
            </div>
